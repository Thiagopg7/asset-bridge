...
- Todas as respostas, explicações e mensagens devem ser em **PT-BR**.
- Commits devem seguir Conventional Commits em PT-BR: `tipo(escopo): descrição curta`
